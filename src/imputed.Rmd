...
### Data prep 
```{r}
deg3_mod <- topTags(lrt3, n = 800, sort.by = "logFC")$table
...
# Stepwise regression
null_full <- stepAIC(null, scope=list(lower=null, upper=full), direction="both")
summary(null_full)
...
cm = table(data_ml_validate_mod[, 3], y_pred) ## Will return a confusion matrix. We notice that 1 COVID 19 patient was misclassified as healthy and 3 healthy patients were misclassified as diseased.
cm
