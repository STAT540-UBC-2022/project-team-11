...
>>>>>>> 74ff0bf57140fe2ee80ff9951cafe4e201b82b91
...
---
# Assessing overall distributions
...
- Data Normalization followed by computing CPM and log2CPM values
```{r, include=FALSE}
dge_mod <- dge[keep_edge,]
```

```{r}
# Number of genes present after filtering
dim(dge_mod)
```
...
---
# Interaction between SARS_test and sex
```{r, echo=FALSE, fig.show = 'hold', fig.align="right"}
plotMD(lrt1, main="Sars_test*Gender")
abline(h=c(-1, 1), col="blue")
de2_summary
```
---
# Interaction between SARS_test and age category
```{r, echo=FALSE,fig.show = 'hold', fig.align="centre"}
...
---
# Interaction between age category and sex
```{r, echo=FALSE, fig.show = 'hold', fig.align="left"}
