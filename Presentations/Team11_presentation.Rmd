...
.pull-right[
```{r, fig.align='right', out.width="75%", echo=FALSE}
#Box plot
longExpr %>%
...
```{r, echo=FALSE, out.width="66%", fig.show = 'hold', fig.align="right"}
plotMD(lrt1, main="Sars_test:Gender")
abline(h=c(-1, 1), col="blue")
```


```{r, echo=FALSE, out.width="66%", fig.show = 'hold', fig.align="centre"}
plotMD(lrt2, main="Sars_test:Age_category")
abline(h=c(-1, 1), col="blue")
```


```{r, echo=FALSE, out.width="66%", fig.show = 'hold', fig.align="left"}
