...
.pull-left[
```{r, echo=FALSE, out.width="70%", fig.show = 'hold', fig.align="right"}
knitr::include_graphics("GeneWiseModel.png")
```
]

.pull-right[
```{r, echo=FALSE, out.width="65%", fig.show = 'hold', fig.align="left"}
...
.pull-right[
```{r, fig.align='right', out.width="80%", echo=FALSE}
#Box plot
longExpr %>%
