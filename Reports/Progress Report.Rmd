...
The following steps describe the methodology used so far in out analyses:
...
4. From the list of up-regulated and down-regulated genes obtained from step 4, principal component analyses was performed using functions from the `stat` package.
5. A logistic regression model was generated to predict infection status based on RNAseq data.

Based on the above steps, aims 1 and 3 of our final proposal were partially answered.
